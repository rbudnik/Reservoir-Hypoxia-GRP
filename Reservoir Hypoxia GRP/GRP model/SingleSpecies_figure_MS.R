...
legTEMP <- get_legend(xsplotTEMP)
legendTEMP <- as.ggplot(legTEMP, vjust = 0.05)
...
legDO <- get_legend(xsplotDO)
legendDO <- as.ggplot(legDO, vjust = 0.05)
...
legPREY <- get_legend(xsplotPREY)
legendPREY <- as.ggplot(legPREY, vjust = 0.05)
...
for(i in 1:8) {  ## loop through each depth plot and generate plot
  ...
  if(doi <= maxz) {
    ...
    layr <- ggplot() +   ## temperature plots
      ...
      scale_fill_gradientn(colours = rev(rainbow(4)), guide = FALSE, na.value = "white", 
                           limits = c(minTEMP, maxTEMP)) +
      geom_polygon(data=outside, aes(x=long, y=lat), fill="white", asp = 1) +   
      islands +
      coord_fixed(ratio = 1, xlim=c(xmin,xmax), ylim=c(ymin, ymax)) +  ## aspect
      theme(panel.background = element_rect(fill = "white", color = "black", size = 2)) +  ## black background
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
      theme(axis.title.x = element_blank(), axis.text.x = element_blank(), axis.ticks = element_blank()) +
      theme(axis.title.y = element_blank(), axis.text.y = element_blank(), axis.ticks = element_blank()) +
      #theme(plot.margin = unit(c(0, 0, 0, 0), "cm")) # For Acton and Burr Oak
      theme(plot.margin = unit(c(0.5, 0, 0, 0), "cm")) # For Pleasant Hill
...
legGRP <- get_legend(xsplotGRP)
legendGRP <- as.ggplot(legGRP, vjust = 0.05)
...
legGRPno <- get_legend(xsplotGRPno)
#legendGRPno <- as.ggplot(legGRPno, vjust = 0.05) # use for Acton and Burr Oak
legendGRPno <- as.ggplot(legGRPno, vjust = 0.05, hjust = 0.1) # Use for Pleasant Hill
...
jpeg(filename = paste("C:/Users/richa/OneDrive/Desktop/", lake,
                     dayoi, "_final.jpeg", sep = ""), width = 190, 
    height = 240, units = "mm", res = 600, restoreConsole = TRUE)

plot <- plot_grid(mT2, mT3, mT4, mD2, mD3, mD4,
                  mT5, mT6, mT7, mD5, mD6, mD7,
                  mT8, legendTEMP, NULL, mD8, legendDO, NULL,
                  mB2, mB3, mB4, m2, m3, m4,
                  mB5, mB6, mB7, m5, m6, m7,
                  mB8, legendPREY, NULL, m8, legendGRP, NULL,
                  NULL, mno2, mno3, mno4, NULL, NULL,
                  NULL, mno5, mno6, mno7, NULL, NULL,
                  NULL, mno8, legendGRPno, NULL, NULL, NULL,
                  ncol = 6)

plot + 

  annotate(geom = "text", x = 0.06, y = 0.91, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.91, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.91, label = "4 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.91, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.91, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.91, label = "4 m", size = 5) +

  annotate(geom = "text", x = 0.06, y = 0.8, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.8, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.8, label = "7 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.8, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.8, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.8, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.06, y = 0.69, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.69, label = "8 m", size = 5) +
  
  
  
  annotate(geom = "text", x = 0.06, y = 0.5775, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.5775, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.5775, label = "4 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.5775, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.5775, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.5775, label = "4 m", size = 5) +

  annotate(geom = "text", x = 0.06, y = 0.4675, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.4675, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.4675, label = "7 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.4675, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.4675, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.4675, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.06, y = 0.3575, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.3575, label = "8 m", size = 5)+
  
  
  
  annotate(geom = "text", x = 0.23, y = 0.245, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.245, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.245, label = "4 m", size = 5) +
  
  annotate(geom = "text", x = 0.23, y = 0.135, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.135, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.135, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.23, y = 0.025, label = "8 m", size = 5) +


  annotate(geom = "text", x = 0.01, y = .99, label = "A", size = 6) +
  annotate(geom = "text", x = 0.51, y = .99, label = "B", size = 6) +
  annotate(geom = "text", x = 0.01, y = .655, label = "C", size = 6) +
  annotate(geom = "text", x = 0.51, y = .655, label = "D", size = 6) +
  annotate(geom = "text", x = 0.18, y = .323, label = "E", size = 6)
...
plot <- plot_grid(mT2, mT3, mT4, mD2, mD3, mD4,
                  mT5, mT6, mT7, mD5, mD6, mD7,
                  mT8, mT10, legendTEMP, mD8, mD10, legendDO,
                  mB2, mB3, mB4, m2, m3, m4,
                  mB5, mB6, mB7, m5, m6, m7,
                  mB8, mB10, legendPREY, m8, m10, legendGRP,
                  NULL, mno2, mno3, mno4, NULL, NULL,
                  NULL, mno5, mno6, mno7, NULL, NULL,
                  NULL, mno8, mno10, legendGRPno, NULL, NULL,
                  ncol = 6)

plot + 

  annotate(geom = "text", x = 0.075, y = 0.985, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.245, y = 0.985, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.985, label = "4 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.985, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.745, y = 0.985, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.91, y = 0.985, label = "4 m", size = 5) +

  annotate(geom = "text", x = 0.075, y = 0.874, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.245, y = 0.874, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.874, label = "7 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.874, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.745, y = 0.874, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.91, y = 0.874, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.075, y = 0.763, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.245, y = 0.763, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.763, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.745, y = 0.763, label = "10 m", size = 5) +
  
  
  
  annotate(geom = "text", x = 0.075, y = 0.6525, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.245, y = 0.6525, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.6525, label = "4 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.6525, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.745, y = 0.6525, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.91, y = 0.6525, label = "4 m", size = 5) +

  annotate(geom = "text", x = 0.075, y = 0.5424, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.245, y = 0.5424, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.5424, label = "7 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.5424, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.745, y = 0.5424, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.91, y = 0.5424, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.075, y = 0.4323, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.245, y = 0.4323, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.4323, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.745, y = 0.4323, label = "10 m", size = 5) +
  
  
  
  annotate(geom = "text", x = 0.245, y = 0.32, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.32, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.32, label = "4 m", size = 5) +
  
  annotate(geom = "text", x = 0.245, y = 0.209, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.209, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.575, y = 0.209, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.245, y = 0.098, label = "8 m", size = 5) +
  annotate(geom = "text", x = 0.41, y = 0.098, label = "10 m", size = 5) +


  annotate(geom = "text", x = 0.02, y = .99, label = "A", size = 6) +
  annotate(geom = "text", x = 0.52, y = .99, label = "B", size = 6) +
  annotate(geom = "text", x = 0.02, y = .655, label = "C", size = 6) +
  annotate(geom = "text", x = 0.52, y = .655, label = "D", size = 6) +
  annotate(geom = "text", x = 0.19, y = .323, label = "E", size = 6)
...
# Before running Pleasant Hill change plot.margin to lines 469, 486, 503, 1071, 1090, 1109, 1126
#   This allows labels to display properly
#   Also need to alter line 1038 for GRPno legend to display properly
...
plot <- plot_grid(mT2, mT3, mT4, mD2, mD3, mD4,
                  mT5, mT6, mT7, mD5, mD6, mD7,
                  mT10, mT12, legendTEMP, mD10, mD12, legendDO,
                  mB2, mB3, mB4, m2, m3, m4,
                  mB5, mB6, mB7, m5, m6, m7,
                  mB10, mB12, legendPREY, m10, m12, legendGRP,
                  NULL, mno2, mno3, mno4, NULL, NULL,
                  NULL, mno5, mno6, mno7, NULL, NULL,
                  NULL, mno10, mno12, legendGRPno, NULL, NULL,
                  ncol = 6)

plot + 

  annotate(geom = "text", x = 0.06, y = 0.915, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.915, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.915, label = "4 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.915, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.915, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.915, label = "4 m", size = 5) +

  annotate(geom = "text", x = 0.06, y = 0.805, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.805, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.805, label = "7 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.805, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.805, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.805, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.06, y = 0.695, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.695, label = "12 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.695, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.695, label = "12 m", size = 5) +
  
  
  annotate(geom = "text", x = 0.06, y = 0.5825, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.5825, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.5825, label = "4 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.5825, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.5825, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.5825, label = "4 m", size = 5) +

  annotate(geom = "text", x = 0.06, y = 0.4725, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.4725, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.4725, label = "7 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.4725, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.4725, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.895, y = 0.4725, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.06, y = 0.3625, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.23, y = 0.3625, label = "12 m", size = 5)+
  annotate(geom = "text", x = 0.56, y = 0.3625, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.73, y = 0.3625, label = "12 m", size = 5)+
  
  
  
  annotate(geom = "text", x = 0.23, y = 0.25, label = "2 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.25, label = "3 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.25, label = "4 m", size = 5) +
  
  annotate(geom = "text", x = 0.23, y = 0.14, label = "5 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.14, label = "6 m", size = 5) +
  annotate(geom = "text", x = 0.56, y = 0.14, label = "7 m", size = 5) +
  
  annotate(geom = "text", x = 0.23, y = 0.03, label = "10 m", size = 5) +
  annotate(geom = "text", x = 0.395, y = 0.03, label = "12 m", size = 5) +
